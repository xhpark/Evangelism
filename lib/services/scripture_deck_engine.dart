...
class ScriptureDeckEngine {
  static final List<ScriptureCard> scriptures = [
    ...
    ScriptureCard(
      ...
      text: "너희는 그 은혜에 의하여 구원을 받았으니 이것은 너희에게서 난 것이 아니요 하나님의 선물이라 행위에서 난 것이 아니니 이는 누구든지 자랑하지 못하게 함이라",
    ...
    ScriptureCard(
      ...
      text: "우리는 다 양 같아서 그릇 행하여 각기 제 길로 갔거늘 여호와께서는 우리 모두의 죄악을 그에게 예수 그리스도에게 담당시키셨도다",
